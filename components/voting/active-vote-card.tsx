...
import { Clock, Vote, Loader2, Calendar, Users, Timer, Plus } from "lucide-react";
              ...
              <div className="z-10">
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button className="p-1 rounded-full hover:bg-muted focus:outline-none" disabled={actionLoading}>
